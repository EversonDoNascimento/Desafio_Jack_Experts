...
router.get("/tasks/qtd/:userId", privateRoute_1.default, TaskController_1.default.getTasksByStatus);
// User Routes
...
router.get("/user/verifyToken", privateRoute_1.default, AuthController_1.default.verifyToken);
